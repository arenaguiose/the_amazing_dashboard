...
with st.container():
    ...
    fig = px.scatter_mapbox(df, lat="latitude", lon="longitude",  hover_data=["price", "availability_365"],   color="room_type", color_continuous_scale=px.colors.cyclical.IceFire, size_max=15, zoom=10)
